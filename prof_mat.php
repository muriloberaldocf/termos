...
<body class="min-vh-100" style="background-color: #F4F6F8; color: #2D3748;">
    ...
    <nav class="navbar shadow-sm py-3" style="background-color: #FFFFFF;">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <h4 class="mb-0 fw-bold" style="color: #DD6B20;">Matemática</h4>
            </div>
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <button class="btn fw-bold rounded-pill px-4 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalNovoTermo" style="background-color: #DD6B20; color: #FFFFFF;">
                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 position-relative card-clicavel" style="background-color: #FFFFFF; border-left: 5px solid #DD6B20 !important;" onclick="abrirFormula('Teorema de Pitágoras', 'a² = b² + c²\n\nUsado para encontrar o comprimento de um dos lados de um triângulo retângulo, conhecendo os outros dois.')">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-3 pt-3 border-top">
                            <button class="btn btn-sm btn-outline-secondary rounded-pill fw-bold px-3" onclick="event.stopPropagation(); prepararEdicao(1, 'Teorema de Pitágoras', 'a² = b² + c²\n\nUsado para encontrar o comprimento de um dos lados de um triângulo retângulo, conhecendo os outros dois.')">
                                Editar
                            </button>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm rounded-4 position-relative card-clicavel" style="background-color: #FFFFFF; border-left: 5px solid #DD6B20 !important;" onclick="abrirFormula('Fórmula de Bhaskara', 'x = (-b ± √(b² - 4ac)) / 2a\n\nMétodo principal utilizado para encontrar as raízes reais de uma equação do segundo grau.')">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-3 pt-3 border-top">
                            <button class="btn btn-sm btn-outline-secondary rounded-pill fw-bold px-3" onclick="event.stopPropagation(); prepararEdicao(2, 'Fórmula de Bhaskara', 'x = (-b ± √(b² - 4ac)) / 2a\n\nMétodo principal utilizado para encontrar as raízes reais de uma equação do segundo grau.')">
                                Editar
                            </button>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header border-0 pb-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <h4 class="modal-title fw-bold mb-0" id="modalTituloLeitura" style="color: #DD6B20;">Título</h4>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <form id="formNovoTermo">
                    <div class="modal-body px-4 py-4">
                        <div class="mb-4">
                            <label class="form-label fw-bold small text-uppercase text-muted">Nome / Assunto</label>
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control rounded-3 border-0 bg-light" name="significado_termo" rows="4" placeholder="Digite a fórmula e a explicação..." required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer border-0 pt-0 pb-4 px-4 d-flex gap-2">
                        ...
                        <button type="submit" class="btn rounded-pill px-4 fw-bold flex-grow-1" style="background-color: #DD6B20; color: #FFFFFF;">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalEditarTermo" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header border-0 pb-0 pt-4 px-4">
                    <h5 class="modal-title fw-bold" style="color: #2D3748;">Editar Assunto</h5>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="formEditarTermo">
                    ...
                    <div class="modal-footer border-0 pt-0 pb-4 px-4 d-flex gap-2">
                        <button type="button" class="btn btn-light rounded-pill px-4 fw-bold flex-grow-1" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn rounded-pill px-4 fw-bold flex-grow-1" style="background-color: #DD6B20; color: #FFFFFF;">Salvar Alterações</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-body p-5 text-center">
                    ...
                    <h4 class="fw-bold mb-3" style="color: #2D3748;">Excluir Assunto?</h4>
                    <p class="text-muted mb-4">Tem certeza que deseja apagar este assunto? Esta ação não poderá ser desfeita.</p>
