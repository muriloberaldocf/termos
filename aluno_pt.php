    ...
    <nav class="navbar shadow-sm py-3" style="background-color: #FFFFFF;">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <h4 class="mb-0 fw-bold" style="color: #3182CE;">Português <span class="badge rounded-pill align-middle ms-2 bg-info text-white" style="font-size: 0.75rem;">Modo Aluno</span></h4>
            </div>
    ...
    <div class="container py-5">
        ...
        <div class="row g-4" id="listaTermos">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm rounded-4 position-relative card-clicavel" style="background-color: #FFFFFF; border-left: 5px solid #3182CE !important;" onclick="abrirTermo('Substantivo', 'Classe de palavras com que se atribui nome aos seres, ações, objetos, características, sentimentos e estados. Pode ser classificado em comum, próprio, concreto, abstrato, etc.')">
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <h5 class="card-title fw-bold mb-0" style="color: #3182CE; font-size: 1.25rem;">Substantivo</h5>
                        ...
                        <p class="card-text text-muted flex-grow-1 texto-limitado" style="font-size: 0.95rem; line-height: 1.6;">
                            Classe de palavras com que se atribui nome aos seres, ações, objetos, características, sentimentos e estados. Pode ser classificado em comum, próprio, concreto, abstrato, etc.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm rounded-4 position-relative card-clicavel" style="background-color: #FFFFFF; border-left: 5px solid #3182CE !important;" onclick="abrirTermo('Verbo', 'Palavra que exprime ação, estado, mudança de estado ou fenômeno da natureza, situando-os no tempo. Os verbos são essenciais para a construção de orações e frases.')">
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <h5 class="card-title fw-bold mb-0" style="color: #3182CE; font-size: 1.25rem;">Verbo</h5>
                            <span class="text-muted" style="opacity: 0.5;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M5.828 10.172a.5.5 0 0 0-.707 0l-4.096 4.096V11.5a.5.5 0 0 0-1 0v3.975a.5.5 0 0 0 .5.5H4.5a.5.5 0 0 0 0-1H1.732l4.096-4.096a.5.5 0 0 0 0-.707zm4.344-4.344a.5.5 0 0 0 .707 0l4.096-4.096V4.5a.5.5 0 1 0 1 0V.525a.5.5 0 0 0-.5-.5H11.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707z"/>
                                </svg>
                        ...
                        <p class="card-text text-muted flex-grow-1 texto-limitado" style="font-size: 0.95rem; line-height: 1.6;">
                            Palavra que exprime ação, estado, mudança de estado ou fenômeno da natureza, situando-os no tempo. Os verbos são essenciais para a construção de orações e frases.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header border-0 pb-0 pt-4 px-4">
                    <h5 class="modal-title fw-bold" style="color: #2D3748;">Sugerir Nova Palavra</h5>
                ...
                <form id="formNovoTermoAluno">
                    ...
                    <div class="modal-footer border-0 pt-0 pb-4 px-4 d-flex gap-2">
                        ...
                        <button type="submit" class="btn rounded-pill px-4 fw-bold flex-grow-1" style="background-color: #3182CE; color: #FFFFFF;">Enviar Termo</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header border-0 pb-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <h4 class="modal-title fw-bold mb-0" id="modalTitulo" style="color: #3182CE;">Título do Termo</h4>
                    </div>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-4 py-4">
                    <p id="modalSignificado" class="text-secondary mb-0 fs-5" style="line-height: 1.8;"></p>
                </div>
